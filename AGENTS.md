...
The repository documents and publishes version `1.0.0`. Describe the current product state in present tense and keep release documentation focused on this version.
...
3. Verify that user-facing names and button labels match the Chinese UI.
